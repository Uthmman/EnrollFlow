...
export const en = {
  ...
  efCheckEntriesToastDesc: "Check entries.",
  efCheckFormEntriesToastDesc: "Please check the form for errors and try again.",
  ...
  efRegSubmittedForReviewToastDesc: "Your registration is submitted and will be reviewed by an admin.",
  efPendingManualReviewMsg: "Pending manual verification by admin.",
  efProofProcessingErrorToastTitle: "Proof Processing Error",
  efProofProcessingErrorDesc: "Could not process payment proof. Please check your submission and try again.",
  ...
  efActionUnavailableToastTitle: "Action Unavailable",
  efCompletePreviousEnrollmentToastDesc: "Please complete or clear the previous enrollment first (by going back from receipt).",
  efCannotEditSubmittedEnrollmentToastDesc: "Cannot edit participants of a submitted enrollment from this view.",
  efPaymentVerificationErrorTitle: "Payment Verification Error",

  // Receipt
  rRegistrationConfirmedTitle: "Registration Submitted!",
  rThankYouDesc: "Thank you for registering. Your submission is pending manual review.",
  ...
  rPaymentSubmittedText: "Payment Submitted - Pending Review",
  rReasonLabel: "Reason:",
  ...
  apProofHeader: "Proof",
  apViewProofTooltip: "View Payment Proof",
  apPaymentProofDialogTitle: "Payment Proof",
  apViewPdfLinkAdmin: "Open PDF Link",
  apScreenshotProofLabel: "Screenshot Proof:",
  apFetchedDocumentLabel: "Fetched Document:",
  apNoScreenshotProvided: "No screenshot was provided or it could not be loaded.",
  apCbeDocFetchFailed: "CBE document could not be automatically fetched. Please verify the transaction ID manually.",
  apPdfLinkFetchFailed: "PDF document could not be automatically fetched from the link. Please verify the link manually.",
  ...
  apManuallyVerifiedBy: "Manually verified by {admin}.",
  apManuallyUnverifiedBy: "Manually unverified by {admin}.",
