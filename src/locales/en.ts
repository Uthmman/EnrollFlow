...
export const en = {
  ...
  adminPanelLabel: "Admin Panel", // This key might be unused now
  ...
  apBankDetailsFirestoreNote: "Bank details are now stored in the 'paymentMethods' collection in Firestore. Future updates will allow editing here.", // To be reviewed if still needed after direct editing
