...
export const en = {
  ...
  // Program specific field labels (placeholders for constants.ts structure)
  ...
  efPrimaryPhoneLabelEF: "Primary Phone Number (for records)", // Added EF suffix to differentiate from receipt
  efPhonePlaceholderEF: "e.g., 0911XXXXXX", // Added EF suffix
